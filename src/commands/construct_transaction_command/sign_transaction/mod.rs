    ...
    pub fn from(
        ...
        match item {
            ...
            CliSignTransaction::SignWithKeychain(cli_key_chain) => {
                let key_chain =
                    self::sign_with_keychain::SignKeychain::from(cli_key_chain, context)?;
...
impl SignTransaction {
    // pub fn choose_sign_option(context: crate::common::Context) -> color_eyre::eyre::Result<Self> {
    //     println!();
    ...
    //           // }
    //     };
    //     Self::from(cli_sign_option, context)
    // }
